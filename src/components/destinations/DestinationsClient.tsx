...
const mockDestinations: Destination[] = [
  ...
  { id: "6", name: "Maldives", slug: "maldives", countryId: "mv", cityId: "c6", images: [], coverImage: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=3840&q=95", rating: 4.8, reviewCount: 2100, priceFrom: 2499, currency: "USD", featured: true, trending: false, country: { id: "mv", name: "Maldives", code: "MV" }, city: { id: "c6", name: "Mal ", countryId: "mv" } },
